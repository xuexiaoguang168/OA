...
title = fchar.getNullString(request.getParameter("title"));
receiver = fchar.getNullString(request.getParameter("receiver"));
content = fchar.getNullString(request.getParameter("content"));
if(title.trim().length()==0||content.trim().length()==0)
	errmsg += "标题和内容不能为空！\n";
if(name.equals(receiver))
  	errmsg += "请不要给自己发信息！\n";
if(!errmsg.equals(""))
	fchar.Alert_Back(errmsg);
...
<table width="320" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#99CCFF" class="9black" height="136">
  <tr> 
  ...
  <tr> 
      <td bgcolor="#FFFFFF" height="152" valign="top">
        ...
        <table width="300" border="0" cellspacing="1" cellpadding="3" align="center" class="9black">
          ...
          <td height="35"> <li>
<jsp:useBean id="Msg" scope="page" class="com.redmoon.forum.message.MessageDb"/>
<%
...
try {
	...
	out.println(fchar.makeErrMsg("消息发送失败："+e.getMessage()));
}
Msg.clear();
%>
<% if (isSuccess) { %>
