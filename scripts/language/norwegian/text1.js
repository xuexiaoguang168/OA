...
function loadText()
    ...
    txtLang[6].innerHTML = "Dekorasjon";
    txtLang[7].innerHTML = "Tekst";
    txtLang[8].innerHTML = "Minicaps";
    txtLang[9].innerHTML = "Vertikal";

    txtLang[10].innerHTML = "Ingen";
    txtLang[11].innerHTML = "Understreket";
    txtLang[12].innerHTML = "Overstreket";
    txtLang[13].innerHTML = "Gjennomstreket";
    txtLang[14].innerHTML = "Normal";

    txtLang[15].innerHTML = "Ingen";
    txtLang[16].innerHTML = "Kapit\u00E6ler";
    txtLang[17].innerHTML = "St. bokstv.";
    txtLang[18].innerHTML = "Sm\u00E5 bokstv.";
    ...
    txtLang[24].innerHTML = "Hevet skrift";
    txtLang[25].innerHTML = "Senket skrift";
