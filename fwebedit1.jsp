...
%><object classid="CLSID:DE757F80-F499-48D5-BF39-90BC8BA54D8C" codebase="<%=request.getContextPath()%>/activex/webedit.cab#version=4,0,1,1" width=400 height=280 align="middle" id="webedit">
            ...
            <tr>
			  ...
			  %>
			  <%if (templateId==-1) {%>
              <input name="cmdok2" type="button" class="singleboarder" value="<%=action%>(断点续传)" onClick="return SubmitWithFileDdxc()">
              <%}
			  if (templateId==-1) {%>
...
&nbsp;&nbsp; <input name="remsg2" type="button" class="singleboarder" onClick="recorderDiv.style.display=''" value="录制语音"></td>
	  <%}%>
            </tr>
        </table>
    </form>
