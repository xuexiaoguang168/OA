        ...
        <table width="300" border="0" cellspacing="1" cellpadding="3" align="center" class="9black">
          <tr> 
            ...
            <td width="217" height="27">
			  ...
			  <input type="button" onClick="openWinUsers()" value="选择用户">
		    <input type=button onClick="openWinUserGroup()" value="按用户组"> <input name="button" type=button onClick="openWinUserRole()" value="按角色"></td></tr>
          <tr> 
