...
<table width="320" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#99CCFF" class="9black" height="260">
  <tr> 
    <td bgcolor="#CEE7FF" height="23">
        <div align="center"><b>草 稿 箱</b></div>
    </td>
  </tr>
  <tr> 
    <td bgcolor="#FFFFFF" height="50"> 
        <table width="300" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            ...
            <td width="75"> 
              <div align="center"><img src="images/m_draftbox.gif" width="40" height="40" border="0"></div>
            </td>
            <td width="75"> 
              <div align="center"><a href="send.jsp"><img src="images/newpm.gif" width="40" height="40" border="0"></a></div>
            </td>
            <td width="75"> 
              <div align="center"><img border="0" name="imageField" src="images/m_delete.gif" width="40" height="40" onClick="form1.submit()" style="cursor:hand"></div>
            </td>
          </tr>
        </table>
    </td>
  ...
  <form name="form1" method="post" action="delmsg.jsp">
		...
		String sql = "select id from oa_message where sender="+StrUtil.sqlstr(name)+" and isDraft=1 order by isreaded asc,rq desc";
		int pagesize = 5;
		 ...
		 %>
            <table width="300" border="0" cellspacing="1" cellpadding="3" align="center" class="9black">
		      ...
		      if(i%2==0)
			   ...
			   i++; %>
              <tr bgcolor="<%=bg%>">
                <td width="21" ><input type="checkbox" name="ids" value="<%=id%>"></td>
                <td width="203" >·<a href="showmsg.jsp?id=<%=id%>" class="9black2"> <%=title%></a> </td>
