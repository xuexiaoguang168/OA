...
%>
<table width="98%" height="577" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%" height="575" valign="top"><%
...
%>
      ...
      <table width=98% height="28" border=0 align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="p9">
		...
		<tr>
          <td width="71%" height=23 align="left" bgcolor="<%=bgcolor%>">&nbsp;<a href="doc_show.jsp?id=$id">$title</a></td>
