...
<table width="90%" border="0" align="center" cellPadding="2" cellSpacing="1" bgcolor="#FFFFFF" class="tableframe">
  <form name="form1" action="vehicle_do.jsp?op=add" method="post" encType="multipart/form-data">
    <tbody>
	  <tr>
      ...
      <tr>
        ...
        <td><input maxLength="100" name="licenseNo" size="20"></td>
        <td width="250" rowSpan="6"><center>暂无照片</center></td>
      </tr>
      <tr>
        <td noWrap>厂牌型号：</td>
        <td><input maxLength="100" name="brand" size="20"></td>
      </tr>
      <tr>
        <td noWrap>发动机号：</td>
        <td><input maxLength="100" name="engineNo" size="20"></td>
      </tr>
      <tr>
        <td noWrap>车辆类型：</td>
        <td><select name="type">
			...
			%>
			<option value="<%=vtd.getId()%>"><%=vtd.getDescription()%></option>
			<%}%>
          </select></td>
      </tr>
      <tr>
        <td noWrap>驾驶员：</td>
        <td><input maxLength="100" size="12" name="driver"></td>
      </tr>
      <tr>
        <td noWrap>购买价格：</td>
        <td><input maxLength="25" size="12" name="price"></td>
      </tr>
      <tr>
        <td noWrap>车辆照片上传：</td>
      ...
      <tr>
        <td noWrap>购买日期：</td>
        <td colSpan="2"><input name="buyDate" size="10"><img style="CURSOR: hand" onClick="SelectDate('buyDate', 'yyyy-MM-dd')" src="../images/form/calendar.gif" align="absMiddle" border="0" width="26" height="26">  
          日期格式形如 1999-1-2</td>  
      </tr>
      <tr>
        <td noWrap>当前状态：</td>
