...
PageConn pageconn = new PageConn(cn.js.fan.web.Global.defaultDB, Integer.parseInt(strcurpage), pagesize);
...
%>
<br>
<table width="70%"  border="0" align="center" cellpadding="0" cellspacing="0" class="p9">
...
<table style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid" cellSpacing="0" cellPadding="3" width="95%" align="center">
  <tbody>
    <tr>
      ...
      <td class="thead" style="PADDING-LEFT: 10px" noWrap width="39%"><img src="images/tl.gif" align="absMiddle" width="10" height="15">标题</td>
...
while (ri.hasNext()) {
    ...
    <tr class="row" style="BACKGROUND-COLOR: #ffffff">
      ...
      <td><a href="fwebedit.jsp?op=edit&id=<%=rr.getInt("id")%>&dir_code=<%=StrUtil.UrlEncode((String)rr.get(1))%>&dir_name=<%=StrUtil.UrlEncode(dir_name)%>">[ 编辑 ]</a> <a onClick="return confirm('您确定要删除吗？')" href="document_list_m.jsp?op=del&id=<%=rr.getString(3)%>&dir_code=<%=dir_code%>&dir_name=<%=StrUtil.UrlEncode(dir_name)%>">[ 删除 ]</a></td>
    </tr>
    <%}%>
  </tbody>
</table>
