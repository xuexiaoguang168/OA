...
%>
      <table width="98%" border='0' align="center" cellpadding='0' cellspacing='0'>
        <tr> 
          <td width="110" colspan="2" valign="top"><table width="100%" border='0' cellspacing='0' cellpadding='0'>
              <tr > 
...
if (!op.equals(""))
{
	...
	{
		sql = "insert into doc_type (id, name) values ("+id+","+fchar.sqlstr(name)+")";
...
ResultSet rs = null;
try {
	sql ="SELECT id,name FROM doc_type where kind=0";
	rs = conn.executeQuery(sql);
	if (rs==null)
		out.println("Ŀǰ   0");
	else { 
