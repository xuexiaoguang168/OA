...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
        ...
        <form name="form1" method="post" action="zipcode.jsp"> <tr> 
            <td height="20" class="stable">城市、区号、邮编查询</td>
          </tr>
          <tr> 
            <td height="26" class="stable">查询关键字： 
              <input name="keyword" type="text" size=12 id="keyword"> 
              查询选项： <select name="searchmode" id="searchmode">
              ...
              </select> <input type="submit" name="Submit" value="查 找"> <input type="reset" name="Submit2" value="重 写"> 
            </td>
          </tr></form>
        </table>
    </td>
  ...
  <tr>
    <td><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#666666" bordercolordark="#FFFFFF" bgcolor="#d6d3ce">
      <tr>
        <td width="22%">
          <div align="center"><font color="#FF0000">省洲名称</font></div>
        </td>
        <td width="30%">
          <div align="center"><font color="#FF0000">地区名称</font></div>
        </td>
        <td width="26%">
          <div align="center"><font color="#FF0000">邮政编码</font></div>
        </td>
        <td width="22%">
          <div align="center"><font color="#FF0000">电话区号</font></div>
        </td>
      </tr>
<%
