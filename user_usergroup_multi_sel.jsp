...
<table width="460" border="0" align="center" cellpadding="0" cellspacing="0" class="tableframe">
  <tr> 
    <td height="24" colspan="4" align="center" class="right-title"><span>用户组</span></td>
  </tr>
  <tr> 
...
<%}%>
  ...
  <tr>
    <td height="30" align="center"><input type="button" value="选择该用户组所有用户" onClick="selAllUserOfDept()"></td>
  </tr>
</table>
	</td>
  </tr>
