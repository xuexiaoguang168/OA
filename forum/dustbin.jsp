...
if (op.equals("del")) {
	...
	out.print(StrUtil.Alert_Redirect(SkinUtil.LoadString(request, "info_op_success"), "dustbin.jsp?checkStatus=" + checkStatus));
}
...
function doDel() {
	...
	window.location.href = "dustbin.jsp?op=del&checkStatus=<%=checkStatus%>&ids=" + ids;
}
...
function doResume() {
	...
	window.location.href = "dustbin.jsp?op=resume&checkStatus=<%=checkStatus%>&ids=" + ids;
}
