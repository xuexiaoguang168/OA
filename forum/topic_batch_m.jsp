  ...
  <tr> 
    <td valign="top"><br>
	  ...
	  <tr>
        ...
        <td width="55%" height="26" bgcolor="#FFFBFF">&nbsp;&nbsp;<lt:Label res="res.label.forum.topic_batch_m" key="from"/><input name="beginDate" value="<%=sBeginDate%>" onclick="showcalendar(event, this)" readonly><lt:Label res="res.label.forum.topic_batch_m" key="to"/>
	  ...
	  <tr>
        ...
        <td width="55%" height="26" bgcolor="#FFFBFF">
          ...
          <lt:Label res="res.label.forum.topic_batch_m" key="not_include"/>        
		 </td>
	  </tr> 
	  <tr>
...
function doOperation() {
	...
	if (operation == "") {
		alert("<lt:Label res="res.label.forum.topic_m" key="need_operation"/>");
		return;
	}
	...
	if(operation == "moveBoard"){
		...
		if(operation == "moveThreadType"){
		    ...
		    if(operation == "msgLevel"){
				...
				if (msglevel == "") {
					alert("<lt:Label res="res.label.forum.topic_m" key="need_level"/>");
					return;
				}
