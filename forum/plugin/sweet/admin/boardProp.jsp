...
SweetBoardDb sb = new SweetBoardDb();
sb = (SweetBoardDb)sb.getObjectDb(boardCode);
  ...
  <tr> 
    <td valign="top"><br>
      ...
      <tr align="center" bgcolor="#FFFFFF">
		...
		%>
<textarea id="sweetRule" name="sweetRule" style="display:none"><%=sb.getSweetRule().replaceAll("\"","'")%></textarea>
