...
if (op.equals("del")) {
	...
	out.print(StrUtil.Alert_Redirect(SkinUtil.LoadString(request, "info_op_success"), "topic_m.jsp?checkStatus=" + checkStatus));
}
...
width="98%" align=center bgColor=#ffffff border=1 class="table_normal">
  ...
  <TR>
        <TD>&nbsp;<a>
          <lt:Label res="res.label.forum.topic_m" key="top_manage"/>
        </a>&nbsp;</TD>
        <TD align=right>
  </TD></TR></TBODY></TABLE>
...
style="PADDING-RIGHT: 0px; BORDER-TOP: 1px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; BORDER-LEFT: 1px; PADDING-TOP: 0px; BORDER-BOTTOM: 1px; BORDER-COLLAPSE: collapse; BORDER-RIGHT-WIDTH: 1px">
    ...
    ><P align=center><SPAN class="text_title">
            <lt:Label res="res.label.forum.search" key="input_keywards"/>
          </SPAN> </P></TD>
        </TR>
        <TR bgColor=#f5f5f5>
          <TD height=24 align="right" 
    style="BORDER-RIGHT: #666666 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: #666666 1px solid; PADDING-LEFT: 1px; PADDING-BOTTOM: 1px; BORDER-LEFT: #666666 1px solid; PADDING-TOP: 1px; BORDER-BOTTOM: #666666 1px solid"><lt:Label res="res.label.forum.search" key="search_content"/>
            &nbsp;&nbsp;</TD>
          <TD 
    ...
    vAlign=top height=24>&nbsp;
        ...
        <TR bgColor=#f5f5f5>
          <TD 
    style="BORDER-RIGHT: #666666 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: #666666 1px solid; PADDING-LEFT: 1px; PADDING-BOTTOM: 1px; BORDER-LEFT: #666666 1px solid; PADDING-TOP: 1px; BORDER-BOTTOM: #666666 1px solid" height=22><P align=right><SPAN style="FONT-SIZE: 9pt">
    ...
    style="BORDER-RIGHT: #666666 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: #666666 1px solid; PADDING-LEFT: 1px; PADDING-BOTTOM: 1px; BORDER-LEFT: #666666 1px solid; PADDING-TOP: 1px; BORDER-BOTTOM: #666666 1px solid" 
    width=210 height=23><P align=right><FONT style="FONT-SIZE: 9pt" 
      color=#000000><lt:Label res="res.label.forum.topic_m" key="check_status"/>
          </FONT>&nbsp;&nbsp; </P></TD>
          <TD 
    style="BORDER-RIGHT: #666666 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: #666666 1px solid; PADDING-LEFT: 1px; PADDING-BOTTOM: 1px; BORDER-LEFT: #666666 1px solid; PADDING-TOP: 1px; BORDER-BOTTOM: #666666 1px solid" 
    vAlign=top height=23>&nbsp;
...
function doDel() {
	...
	window.location.href = "topic_m.jsp?op=del&checkStatus=<%=checkStatus%>&ids=" + ids;
}
...
function doCheck() {
	...
	window.location.href = "topic_m.jsp?op=check&checkStatus=<%=checkStatus%>&ids=" + ids;
}
...
function doResume() {
	...
	window.location.href = "topic_m.jsp?op=resume&checkStatus=<%=checkStatus%>&ids=" + ids;
}
