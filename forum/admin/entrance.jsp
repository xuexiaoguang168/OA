...
<title><lt:Label res="res.label.forum.admin.entrance" key="plugin_manager"/></title>
...
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  ...
  <tr> 
    <td valign="top"><br>
      <table width="92%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
      ...
      <td width="20%" height="24" bgcolor="#EFEBDE"><strong><lt:Label res="res.label.forum.admin.entrance" key="name"/></strong></td>
        <td width="49%" height="24" bgcolor="#EFEBDE"><strong><lt:Label res="res.label.forum.admin.entrance" key="desc"/></strong></td>
	...
	%>
      <tr align="center">
        <td height="24" bgcolor="#F7EEF4"><%=eu.getCode()%></td>
      <td height="24" bgcolor="#F7EEF4"><%=eu.getName()%></td>
        <td height="24" bgcolor="#F7EEF4"><%=eu.getDesc(request)%></td>
