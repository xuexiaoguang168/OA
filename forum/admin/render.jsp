...
%>
      ...
      <td height="22" bgcolor="#FFFBFF"><%=leaf.getName()%></td>
        ...
        <td height="22" bgcolor="#FFFBFF"><a href="render.jsp?op=del&boardCode=<%=StrUtil.UrlEncode(leaf.getCode())%>&renderCode=<%=StrUtil.UrlEncode(sb.getRenderCode())%>"><lt:Label key="op_del"/></a></td>
      </tr>
<%}%>	  
    </table>
