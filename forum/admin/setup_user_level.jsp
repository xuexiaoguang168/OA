...
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  ...
  <tr> 
    <td valign="top"><br>
      <table width="91%"  border="0" align="center" cellpadding="2" cellspacing="0" class="tableframe_gray">
      <tr align="center" bgcolor="#F8F7F9">
        <td width="16%" height="24" bgcolor="#E1EAEC"><strong><%=level%></strong></td>
        <td width="32%" height="24" bgcolor="#E1EAEC"><strong>
          <lt:Label res="res.label.forum.admin.setup_user_level" key="desc"/>
        </strong></td>
        <td width="17%" bgcolor="#E1EAEC"><strong>图片</strong></td>
        <td width="16%" bgcolor="#E1EAEC">所属用户组</td>
        <td width="19%" bgcolor="#E1EAEC"><strong>
        <lt:Label key="op"/>
      </strong></td>
      </tr>
	<%
