...
<table style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid" cellSpacing="0" cellPadding="3" width="95%" align="center">
  <tbody>
    <tr>
      ...
      <td class="thead" noWrap width="13%"><img src="images/tl.gif" align="absMiddle" width="10" height="15">
        <lt:Label res="res.label.forum.admin.user_group_m" key="system"/></td><td width="35%" noWrap class="thead"><img src="images/tl.gif" align="absMiddle" width="10" height="15"><lt:Label key="op"/></td>
    </tr>
...
</a> ]&nbsp;[&nbsp;<a href="user_group_priv_frame.jsp?groupCode=<%=StrUtil.UrlEncode(code)%>" target="_blank">权限</a>&nbsp;]</td>
    </tr>
<%}%>
  </tbody>
</table>
