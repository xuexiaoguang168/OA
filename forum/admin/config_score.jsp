...
<%
int k = 0;
String code="", name = "", regist = "", login = "", add = "",reply = "", elite = "", del = "",className="", type="", exchange="", desc="", advertiseLink="", attachment="", attachmentDel="";
...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1">
  ...
  <tr>
    <td width="11%" bgcolor="#F6F6F6"><lt:Label res="res.label.forum.admin.config_score" key="regist"/></td>
    <td width="89%" bgcolor="#F6F6F6"><input type="input" name="regist" value="<%=regist%>"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="#F6F6F6"><lt:Label res="res.label.forum.admin.config_score" key="exchange"/></td>
    <td bgcolor="#F6F6F6">
		<select name="exchange">
           <option value="1" selected><lt:Label res="res.label.forum.admin.config_score" key="yes"/></option>
           <option value="0"><lt:Label res="res.label.forum.admin.config_score" key="no"/></option>
		</select>
  ...
  <tr>
    <td bgcolor="#F6F6F6"><lt:Label res="res.label.forum.admin.config_score" key="desc"/></td>
    <td bgcolor="#F6F6F6"><input type="input" name="desc" value="<%=desc%>"></td>
  </tr>
  <tr>
