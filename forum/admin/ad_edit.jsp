          ...
          <tbody style="display: yes">
            ...
            <tr>
              ...
              <td><span class="TableData">
				...
				%>
                <textarea name="boardNames" cols="30" rows="5" readOnly wrap="yes" id="boardNames"><%=boardNames%></textarea>
                <br>&nbsp;
            ...
            <tr>
              ...
              <td ><input size="30" name="begin_date" onclick="showcalendar(event, this)" value="<%=DateUtil.format(ad.getDate("begin_date"), "yyyy-MM-dd")%>">
              </td>
            </tr>
            <tr>
              ...
              <td><input size="30" name="end_date" onclick="showcalendar(event, this)" value="<%=DateUtil.format(ad.getDate("end_date"), "yyyy-MM-dd")%>">
              </td>
            </tr>
        </table>
		<div id="kind"></div>
        ...
        <div id="kind_0" style="display:none" >
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
            ...
            <tr>
              ...
              <td><textarea rows="5" name="content" id="content" cols="30"><%=ad_kind==ad.KIND_HTML?ad.getString("content"):""%></textarea></td>
            </tr>
          </table>
        </div>
