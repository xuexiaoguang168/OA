...
<TABLE class="frame_gray" cellSpacing=0 cellPadding=0 width="95%" align=center>
  <TBODY>
    <TR>
      <TD valign="top" bgcolor="#FFFBFF" class="thead">&nbsp;</TD>
    </TR>
    <TR>
              ...
              <td height="23" colspan=3 align="center" class="stable"><table width="100%">
                  <tr>
                    <td width="43%" height="26">
                      <lt:Label res="res.label.forum.admin.forum_m" key="status"/>
                      <select name="status">
						...
						form5.status.value = "<%=fd.getStatus()%>"
                          ...
                          <textarea id="reason" name="reason" style="display:none"><%=fd.getReason().replaceAll("\"","'")%></textarea></td></tr>
                  <tr>
                    <td height="22"><%
