...
if (op.equals("edit")) {
	...
	if (userName.equals("")) {
		...
		if (!ud.isLoaded())
			errMsg += SkinUtil.LoadString(request, "res.label.forum.admin.entrance", "user_not_exist") + "\\r\\n";
		else if (!ud.isValid())
...
%>	
	...
	<table width="40%"  border="0" align="center" cellpadding="5" class="tableframe_gray">
        ...
        <tr>
          ...
          <td align="left"><%=userName%><input name="userName" type="hidden" id="userName" value="<%=userName%>"></td>
        </tr>
