...
Leaf rootleaf = dir.getLeaf(root_code);
String root_name = rootleaf.getName();
%>
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">管理&nbsp;<%=root_name%>&nbsp;&nbsp;<a href="dir_sub_all.jsp?root_code=<%=StrUtil.UrlEncode(root_code)%>">简单模式</a></td>
  </tr>
</table>
<br>
...
<%
DirectoryView tv = new DirectoryView(rootleaf);
tv.list(out);
%>
</TD>
    </TR>
