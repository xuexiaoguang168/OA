    ...
    <td>
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
          <tr> 
            ...
            <%=memberTotal%></td>
            <td bgcolor=#F6F6F6 width='20%'><lt:Label res="res.label.forum.admin.forum_statistic" key="topic_count"/>
            <%=addCount%></td>
            <td bgcolor=#F6F6F6 width='20%'><lt:Label res="res.label.forum.admin.forum_statistic" key="post_count"/>
            <%=allCount%></td>
            <td width="20%" bgcolor=#F6F6F6><lt:Label res="res.label.forum.admin.forum_statistic" key="elite_count"/>
            <%=eliteCount%></td>
            <td width="20%" align=center bgcolor=#F6F6F6><input type=submit value='<lt:Label res="res.label.forum.admin.forum_statistic" key="count_again"/>'/></td>
          </tr>
      </table>    </td>
  </tr>
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tableframe" style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid" >
  ...
  <tr> 
    <td>
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
          <tr> 
            <td bgcolor=#F6F6F6 width='10%' align="center"><lt:Label res="res.label.forum.admin.forum_statistic" key="user_name"/></td>
            <td bgcolor=#F6F6F6 width='24%'><input type=text value="" name="nick"></td>
			<td width="66%" align=left bgcolor=#F6F6F6><input type="submit" value='<lt:Label res="res.label.forum.admin.forum_statistic" key="count_again"/>'/></td>
          </tr>
      </table>    </td>
  </tr>
  <tr class=row style="BACKGROUND-COLOR: #fafafa">
...
<table style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid" cellSpacing="0" cellPadding="3" width="80%" align="center">
  <tbody>
    <tr>
...
%>
    <tr>
      <td bgcolor=#F6F6F6 width="20%"><%=nick%></td>
      <td width="22%" bgcolor=#F6F6F6><%=userAddCount%></td>
      <td width="29%" bgcolor=#F6F6F6><%=userEliteCount%></td>
      <td width="29%" bgcolor=#F6F6F6><input type="submit" value='<lt:Label res="res.label.forum.admin.forum_statistic" key="count_again"/>'/>
