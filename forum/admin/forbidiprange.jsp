  ...
  <tr> 
    <td valign="top"><br>
      ...
      <tr align="center" bgcolor="#F8F7F9">
        <td width="13%" height="24" bgcolor="#EFEBDE"><strong><lt:Label res="res.label.forum.admin.forbidip" key="begin"/></strong></td>
        <td width="12%" bgcolor="#EFEBDE"><strong><lt:Label res="res.label.forum.admin.forbidip" key="end"/></strong></td>
        <td width="14%" height="24" bgcolor="#EFEBDE"><strong><lt:Label res="res.label.forum.admin.forbidip" key="user_name"/></strong></td>
        <td width="37%" height="24" bgcolor="#EFEBDE"><strong><lt:Label res="res.label.forum.admin.forbidip" key="reason"/></strong></td>
        <td width="15%" bgcolor="#EFEBDE"><strong><lt:Label res="res.label.forum.admin.forbidip" key="forbid_date"/></strong></td>
        <td width="9%" bgcolor="#EFEBDE"><strong><lt:Label key="op"/></strong></td>
      </tr>
	<%
	...
	%>
      <tr align="center">
        <td height="24" bgcolor="#FFF7FF"><%=fid.getBegin()%></td>
      	<td bgcolor="#FFF7FF"><%=fid.getEnd()%></td>
