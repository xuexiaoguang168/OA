...
while (ir.hasNext()) {
    ...
    <tr class="row" style="BACKGROUND-COLOR: #ffffff">
      ...
      <td><%=desc%></td>
      <td>
	  <a href="dir_priv_m.jsp?op=add&dirCode=<%=StrUtil.UrlEncode(leaf.getCode())%>&name=<%=StrUtil.UrlEncode(code)%>&type=0">[ 添加 ]</a></td>
    </tr>
<%}%>
  </tbody>
</table>
<br>
<table width="331"  border="0" cellpadding="0" cellspacing="0"  style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid">
  <tr>
    <td width="329" class="thead">添加用户</td>
  </tr>
  <form action="dir_priv_m.jsp?op=add" method=post>
  <tr>
