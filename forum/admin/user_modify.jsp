      ...
      <table width="550" border="0" align="center" class="frame_gray">
        <form name=form2 action="user_modify.jsp?op=modify" method="post">
          ...
          <tr>
			...
			<input type="checkbox" name="checkStatus" value="<%=user.CHECK_STATUS_PASS%>" <%=user.getCheckStatus()==user.CHECK_STATUS_PASS?"checked":""%>>
			<lt:Label res="res.label.forum.admin.user_m" key="check_pass"/>
			</td>
            </tr>
          <tr>
            <td>&nbsp;</td>
