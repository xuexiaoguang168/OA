...
function setDepts() {
   var depts = dialogArguments.getDepts();
   var ary = depts.split(",");
...
<table width="460" border="0" align="center" cellpadding="0" cellspacing="0" class="tableframe">
  <tr> 
    <td height="24" colspan="2" align="center" background="images/top-right.gif" class="right-title">组 织 机 构 图</td>
  </tr>
