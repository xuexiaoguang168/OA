...
%>
<table width="98%" height="227" border='0' align="center" cellpadding='0' cellspacing='0' class="main">
  <tr>
    <td height=20 align="left" class="right-title">&nbsp;会议室列表</td>
  </tr>
  <tr>
    <td valign="top"><br>
      ...
      <table width="86%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666"">
          <tr align="center" bgcolor="#F1EDF3">
            <td width="15%" height="22">名称</td>
            <td width="20%" height="22">人数</td>
            <td width="19%">地点</td>
            <td width="19%">设备</td>
            <td width="27%">操作</td>
          </tr>
...
%>
      ...
      <DIV style="WIDTH: 92%" align=right>
        <INPUT name="image" type=image onClick="javascript:location.href='boardroom_add.jsp'" src="../admin/images/btn_add.gif" width=80 height=20>
      </DIV></td>
  </tr>
</table>
<br>
