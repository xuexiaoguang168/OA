...
<table cellSpacing="0" cellPadding="0" width="100%">
  <tbody>
    <tr>
      <td height="28" class="head">映射文件列表</td>
    </tr>
  </tbody>
</table>
<br>
<table style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid" cellSpacing="0" cellPadding="3" width="95%" align="center">
  <tbody>
    <tr>
      ...
      <td class="thead" style="PADDING-LEFT: 10px" noWrap width="15%"><img src="../admin/images/tl.gif" align="absMiddle" width="10" height="15">大小</td>
      <td class="thead" noWrap width="15%"><img src="../admin/images/tl.gif" align="absMiddle" width="10" height="15">类型</td>
      <td class="thead" noWrap width="20%"><img src="../admin/images/tl.gif" align="absMiddle" width="10" height="15">修改时间</td>
      <td class="thead" noWrap width="20%"><img src="../admin/images/tl.gif" align="absMiddle" width="10" height="15">操作</td>
    </tr>
<%
String path = "";
Iterator dir = null;
