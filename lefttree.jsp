...
<tr><td height="22"><B><img src="images/smileface.gif" width="15" height="15" align="absmiddle">&nbsp;<a href="javascript:loadOfficeUI('user/user_edit.jsp');window.top.hideOnline()"><span class="right-title" style="cursor:hand"><%=privilege.getUser(request)%></span></a></B>   <a href="javascript:checkall()"><u>展开/收缩</u></a></td></tr></table>
...
>我的办公桌</A></DIV>
<DIV id="div1" style="cursor:hand" onClick="displaysubdiv(1)" isopen=1><IMG align=absMiddle alt="" border=0 id=chainimg1 src="images/left/tminus.gif">&nbsp;&nbsp;<img align=absMiddle alt="" border=0 class=havechild id=folderimg1 src="images/left/icon_folderopen.gif">&nbsp;&nbsp;行政管理</DIV>
<DIV id="subdiv1"> 
<div>
...
src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
src="images/left/icon-work.gif"> <a class=folderlink href="javascript:loadOfficeUI('flow_list_attend.jsp');window.top.hideOnline()" 
>我的流程</a><br>
<!--<NOBR><IMG align=absMiddle src="images/left/i.gif">&nbsp; <IMG align=absMiddle src="images/left/i.gif"><IMG align=absMiddle 
src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
...
>用户管理</A></DIV>
  <DIV><NOBR><IMG align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
src="images/left/icon-user.gif"> <A class=folderlink href="javascript:loadOfficeUI('admin/account_list.jsp')" 
>工号管理</A></DIV>
  <DIV><NOBR><IMG align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><IMG align=absMiddle 
		src="images/left/l.gif"><IMG align=absMiddle alt=Folder 
...
<%if (privilege.isUserPrivValid(request, "admin")) {%>
    <DIV><NOBR><IMG align=absMiddle src="images/left/i.gif"><IMG align=absMiddle 
src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
src="images/left/icon-user.gif">&nbsp;<A class=folderlink href="javascript:loadOfficeUI('admin/netdisk_public_dir_frame.jsp')">公共共享</A></DIV>
<%}%>
<%if (privilege.isUserPrivValid(request, "admin")) {%>
...
src="images/left/icon-doctype.gif">&nbsp;工作流</div>
    <div id="subdiv105" name="subdiv105"><img align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><img align=absMiddle 
      ...
      <img align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif"> <A class=folderlink href="javascript:loadOfficeUI('admin/flow_predefine_frame.jsp')">预设流程</A><NOBR><br>
<%if (privilege.isUserPrivValid(request, "admin")) {%>
		<img align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
	...
	<img align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><IMG align=absMiddle 
		src="images/left/l.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doctype.gif"> <A class=folderlink href="javascript:loadOfficeUI('admin/flow_sequence_list.jsp')">序列控件</A>
<%}%>		
</DIV>
...
<%	}
        ...
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif"> <A class=folderlink href="javascript:loadOfficeUI('forum/admin/forum_notice.jsp')" 
		>论坛通知</A><br>	
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif"> <A class=folderlink href="javascript:loadOfficeUI('forum/topic_m.jsp')" 
        ...
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif"> <A class=folderlink href="javascript:loadOfficeUI('forum/topic_check.jsp')" 
		>审核贴子</A><br>	
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif"> <A class=folderlink href="javascript:loadOfficeUI('forum/topic_batch_m.jsp')" 
		>批量管理</A><br>	
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif"> <A class=folderlink href="javascript:loadOfficeUI('forum/dustbin.jsp')" 
		>回收站</A><br>	
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif"> <A class=folderlink href="javascript:loadOfficeUI('forum/admin/config_time.jsp')" 
		>时间段设置</A><br>											
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
        ...
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif">&nbsp;<A  class=folderlink href="javascript:loadOfficeUI('forum/admin/user_m.jsp')">用户管理</A><br>
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif">&nbsp;<A  class=folderlink href="javascript:loadOfficeUI('forum/admin/config_score.jsp')">积分管理</A><br>
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif">&nbsp;<A  class=folderlink href="javascript:loadOfficeUI('forum/admin/forum_status.jsp')">论坛状态</A><br>
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif">&nbsp;<A  class=folderlink href="javascript:loadOfficeUI('forum/admin/forum_statistic.jsp')">论坛统计</A><br>		
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif">&nbsp;<A  class=folderlink href="javascript:loadOfficeUI('forum/admin/ad_list.jsp')">广告管理</A><br>	
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif">&nbsp;<A  class=folderlink href="javascript:loadOfficeUI('forum/admin/water_mark.jsp')">水印图片</A><br>					
        <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
		src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doc.gif">&nbsp;<A  class=folderlink href="javascript:loadOfficeUI('forum/admin/theme_config.jsp')">主题横幅</A><br>		
  <img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<IMG align=absMiddle 
		src="images/left/l.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doctype.gif"> <A  class=folderlink href="javascript:loadOfficeUI('forum/admin/forum_face.jsp')">头像管理</A>			</DIV>
...
<img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<img align=absMiddle 
	...
	<img align=absMiddle src="images/left/i.gif">&nbsp;&nbsp;<img align=absMiddle src="images/left/i.gif">&nbsp;<IMG align=absMiddle 
		src="images/left/l.gif"><IMG align=absMiddle alt=Folder 
		src="images/left/icon-doctype.gif"> <A  class=folderlink href="javascript:loadOfficeUI('blog/admin/blog_list.jsp')">博客列表</A>
</DIV>
<%}%>
...
src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
src="images/left/icon-doctype.gif"> <A  class=folderlink href="javascript:loadOfficeUI('admin/scheduler_list.jsp')" 
>调度中心</A><br>
<nobr><img align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><img align=absMiddle 
src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
...
<nobr><img align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><img align=absMiddle 
src="images/left/t.gif"><IMG align=absMiddle alt=Folder 
src="images/left/icon-doctype.gif"> <A  class=folderlink href="javascript:loadOfficeUI('message_oa/send_sms_search.jsp')" 
>短讯查询</A><br>
<%}%>
<nobr><img align=absMiddle src="images/left/i.gif">&nbsp; <img align=absMiddle src="images/left/i.gif"><IMG align=absMiddle 
src="images/left/l.gif"><img align=absMiddle alt=Folder 
...
<%}%>
<%}%>
<DIV><NOBR><IMG align=absMiddle alt="" border=0 src="images/left/tminus.gif"><IMG 
