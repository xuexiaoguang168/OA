...
<table width="90%" border="0" align="center" cellPadding="2" cellSpacing="1" bgcolor="#FFFFFF" class="tableframe">
  <form name="form1" action="archive_family_do.jsp?op=add" method="post">
    <tbody>
	  <tr>
		<td colspan="3" class="right-title">添加家庭信息</td>
	  </tr>
      <tr>
      ...
      <tr>
        <td noWrap>成员姓名：</td>
        <td colSpan="2"><input maxLength="100" name="name" size="20"></td>
      </tr>
      <tr>
        <td noWrap>出生日期：</td>
        <td colSpan="2"><input maxLength="100" name="birthday" size="20"><img style="CURSOR: hand" onClick="SelectDate('birthday', 'yyyy-MM-dd')" src="../images/form/calendar.gif" align="absMiddle" border="0" width="26" height="26">  
          日期格式形如 1999-1-2</td>
      </tr>
      <tr>
        <td noWrap>政治面貌：</td>
      ...
      <tr>
        <td noWrap>工作单位：</td>
        <td colSpan="2"><input maxLength="100" name="unit" size="20"></td>  
      </tr>
      <tr>
        <td noWrap>联系地址：</td>
        <td colSpan="2"><input maxLength="100" name="address" size="20"></td>
      </tr>
      <tr>
        <td noWrap>联系电话：</td>
        <td colSpan="2"><input maxLength="100" name="phone" size="20"></td>
      </tr>
      <tr>
        <td noWrap>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
