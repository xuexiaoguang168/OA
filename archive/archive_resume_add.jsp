...
<table width="90%" border="0" align="center" cellPadding="2" cellSpacing="1" bgcolor="#FFFFFF" class="tableframe">
  <form name="form1" action="archive_resume_do.jsp?op=add" method="post">
    <tbody>
	  <tr>
		<td colspan="3" class="right-title">添加履历信息</td>
	  </tr>
      <tr>
      ...
      <tr>
        <td noWrap>单位名称：</td>
        <td colSpan="2"><input maxLength="100" name="company" size="20"></td>
      </tr>
      <tr>
        <td noWrap>担任工作：</td>
      ...
      <tr>
        <td noWrap>开始时间：</td>
        <td colSpan="2"><input maxLength="100" name="beginDate" size="20"><img style="CURSOR: hand" onClick="SelectDate('beginDate', 'yyyy-MM')" src="../images/form/calendar.gif" align="absMiddle" border="0" width="26" height="26">  
          日期格式形如 1999-1-2</td>
      </tr>
      <tr>
        <td noWrap>结束时间：</td>
        <td colSpan="2"><input maxLength="100" name="endDate" size="20"><img style="CURSOR: hand" onClick="SelectDate('endDate', 'yyyy-MM')" src="../images/form/calendar.gif" align="absMiddle" border="0" width="26" height="26">  
          日期格式形如 1999-1-2</td>
      </tr>
      <tr>
        <td noWrap>离职原因：</td>
