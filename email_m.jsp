...
<%
if (!privilege.isUserPrivValid(request, Priv.PRIV_EMAIL))
{
...
<a href="javascript:showModalDialog('cms/doc_template_select_frame.jsp',window.self,'dialogWidth:800px;dialogHeight:480px;status:no;help:no;')">
		  ...
		  <tr>
		    ...
		    <td height="28" align="left"><span class="unnamed2">
		      <input name="senderName" class="singleboarder" value="<%=senderName.equals("")?Global.AppName:senderName%>" size=20>
		    </span></td>
		    </tr>
		  <tr>
		    <td height=20 align="left">&nbsp;</td>
		    ...
		    <td height="28" align="left"><span class="unnamed2">
		      <input name="subject" class="singleboarder" value="<%=subject%>" size=40>
		    </span></td>
		    </tr>
		  <tr>
